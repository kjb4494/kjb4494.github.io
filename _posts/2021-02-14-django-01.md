...
- run server
    ...
    ```
    ![사진](/legacy/python/django-01-001.png){: .normal}
...
- app 생성
    ...
    ![사진](/legacy/python/django-01-002.png){: .normal}
...
- 프로젝트의 urls.py에 testapp urls 추가
    ...
    ```
- run server
    ![사진](/legacy/python/django-01-003.png){: style="min-width: 100%"}
    ```shell
    python manage.py runserver 8000
    ```
...
### 결과물 파일 구조
![사진](/legacy/python/django-01-004.png){: .normal}
