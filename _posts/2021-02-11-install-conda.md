...
- [*Miniconda 설치하기*](https://docs.conda.io/en/latest/miniconda.html)
  ![사진](/legacy/python/install-conda-001.png){: style="min-width: 100%"}
  환경 변수에 추가하기 체크
...
- 설치 후 파워쉘에서 사용할 수 있도록 초기화
    ...
    ![사진](/legacy/python/install-conda-002.png){: style="min-width: 100%"}
    ![사진](/legacy/python/install-conda-003.png){: style="min-width: 100%"}
