...
- urls.py
    ...
    ```
![사진](/legacy/python/django-05-001.png){: .normal}

잘 동작한다. :)

### Template 추가하기
![사진](/legacy/python/django-05-002.png)
...
```
![사진](/legacy/python/django-05-003.png){: .normal}
...
![사진](/legacy/python/django-05-004.png){: .normal}

- admin 페이지에서 question 추가

![사진](/legacy/python/django-05-005.png){: .normal}

- 1번째 question detail 페이지

![사진](/legacy/python/django-05-006.png){: .normal}

- index 페이지

![사진](/legacy/python/django-05-007.png){: .normal}
